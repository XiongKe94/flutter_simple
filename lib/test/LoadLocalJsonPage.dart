...
class LoadLocalJsonPage extends StatefulWidget {
  @override
  _LoadLocalJsonPageState createState() => _LoadLocalJsonPageState();
}

class _LoadLocalJsonPageState extends State<LoadLocalJsonPage> {
  @override
